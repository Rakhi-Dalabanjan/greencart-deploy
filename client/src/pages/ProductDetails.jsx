        ...
        <div className="mt-12">
            ...
            <div className="flex flex-col md:flex-row gap-16 mt-4">
                ...
                <div className="text-sm w-full md:w-1/2">
                    ...
                    {/* ✅ Show Expiry Date */}
                    <div className="mt-4">
                        <p className="text-base font-medium text-gray-600">Expiry Date: <span className="text-black">{expiryDate.toLocaleDateString()}</span></p>
                        {isExpiringSoon && (
                            <p className="text-red-600 font-semibold mt-1">⚠️ This product is expiring in {daysToExpire} day(s)!</p>
                        )}
                    </div>
